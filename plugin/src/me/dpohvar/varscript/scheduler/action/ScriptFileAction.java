 ...
 * Time: 9:38
 */
public class ScriptFileAction extends TaskAction {
    ...
    public ScriptFileAction(Task task, String param) {
        super(task);
        this.param = param;
    }
    ...
    protected boolean register() {
        ...
        engine = runtime.getEngine(pp[0]);
        if (engine == null) return false;
        file = pp[1];
        if (!file.matches("[a-zA-Z][a-zA-Z0-9_]*")) return false;
        params = new String[pp.length - 2];
    ...
    public String toString() {
        return "SCRIPTFILE" + (param == null || param.isEmpty() ? "" : " " + param);
    }
