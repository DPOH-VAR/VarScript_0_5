...
public class RuleInteger extends ConvertRule<Integer> {
    ...
    @Override
    public <V> Integer convert(V object, org.dpohvar.varscript.vs.Thread thread, Scope scope) throws NextRule {
        ...
        try {
            if (object instanceof Score) return ((Score) object).getScore();
        } catch (NoClassDefFoundError ignored) {
        }
