...
import org.dpohvar.varscript.utils.reflect.ReflectBukkitUtils;
import org.dpohvar.varscript.utils.reflect.ReflectUtils;
...
public class RuleItemStack extends ConvertRule<ItemStack> {
    ...
    @Override
    public <V> ItemStack convert(V object, org.dpohvar.varscript.vs.Thread thread, Scope scope) throws NextRule {
