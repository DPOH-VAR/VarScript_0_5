...
public class RuleString extends ConvertRule<String> {
    ...
    @Override
    public <V> String convert(V object, org.dpohvar.varscript.vs.Thread thread, Scope scope) throws NextRule {
        ...
        if (object instanceof Fieldable) {
            try {
                ...
                org.dpohvar.varscript.vs.Runnable run = (org.dpohvar.varscript.vs.Runnable) f.getField("toString");
