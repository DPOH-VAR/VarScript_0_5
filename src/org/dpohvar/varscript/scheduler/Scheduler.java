...
import static org.dpohvar.varscript.config.ConfigKey.SCHEDULER_ENABLED;
...
public class Scheduler {
    ...
    public final org.dpohvar.varscript.Runtime runtime;
    ...
    public Scheduler(Runtime runtime, File home) {
        this.runtime = runtime;
        config = runtime.plugin.getConfigManager();
        this.home = home;
        if (!home.isDirectory()) {
            if (!home.mkdirs()) throw new RuntimeException("Scheduler home not exists:" + home);
        }
    ...
    public Status getStatus() {
        ...
        for (Task task : getTasks()) {
            ...
            if (s == Status.ERROR || s == Status.INVALID) return Status.ERROR;
        }
        return Status.RUN;
    }
