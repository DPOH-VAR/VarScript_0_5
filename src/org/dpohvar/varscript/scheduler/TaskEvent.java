...
import org.dpohvar.varscript.scheduler.event.BukkitEvent;
import org.dpohvar.varscript.scheduler.event.CronEvent;
import org.dpohvar.varscript.scheduler.event.RepeatEvent;
import org.dpohvar.varscript.scheduler.event.TaskLoadEvent;
...
public abstract class TaskEvent extends TaskEntry {
    ...
    public static TaskEvent fromString(Task task, String s) {
        ...
        if ("BUKKIT".equals(type)) {
            ...
            return new CronEvent(task, argument);
        }
