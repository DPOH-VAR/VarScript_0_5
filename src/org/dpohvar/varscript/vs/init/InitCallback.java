...
import org.dpohvar.varscript.vs.compiler.ComplexCompileRule;
...
public class InitCallback {
    ...
    public static Worker<Void> wMapStart = new Worker<Void>() {
        @Override
        public void run(ThreadRunner r, org.dpohvar.varscript.vs.Thread v, Context f, Void d) throws Exception {
    ...
    public static Worker<Void> wMapCheck = new Worker<Void>() {
        ...
        public void run(ThreadRunner r, Thread v, Context f, Void d) throws Exception {
            ...
            if (iterator != null && iterator.hasNext()) {
                ...
                v.push(apply);
                v.pushFunction((org.dpohvar.varscript.vs.Runnable) f.getRegisterA(), apply).setRegisterE(f);
    ...
    public static Worker<Void> wTry = new Worker<Void>() {
        @Override
        public void run(ThreadRunner r, Thread v, Context f, Void d) throws Exception {
            org.dpohvar.varscript.vs.Runnable fun = v.pop(f.getScope());
    ...
    public static Worker<Void> wFoldStart = new Worker<Void>() {
        @Override
        public void run(ThreadRunner r, Thread v, Context f, Void d) throws Exception {
            org.dpohvar.varscript.vs.Runnable run = v.pop(f.getScope());
    ...
    public static Worker<Void> wDoCheck = new Worker<Void>() {
        @Override
        public void run(ThreadRunner r, Thread v, Context f, Void d) throws Exception {
            org.dpohvar.varscript.vs.Runnable run = (org.dpohvar.varscript.vs.Runnable) f.getRegisterA();
    ...
    public static Worker<Void> wFilterCheck = new Worker<Void>() {
        ...
        public void run(ThreadRunner r, Thread v, Context f, Void d) throws Exception {
            ...
            if (iterator != null && iterator.hasNext()) {
                ...
                v.push(apply);
                v.pushFunction((org.dpohvar.varscript.vs.Runnable) f.getRegisterA(), apply).setRegisterE(f); // E - callback
                throw interruptFunction;
            } else {
