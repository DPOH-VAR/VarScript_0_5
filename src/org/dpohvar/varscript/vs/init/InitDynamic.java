...
import org.dpohvar.varscript.converter.rule.RuleItemStack;
...
import org.dpohvar.varscript.vs.compiler.*;
import org.dpohvar.varscript.vs.exception.CloseFunction;
...
import static org.dpohvar.varscript.utils.VarScriptIOUtils.*;
...
public class InitDynamic {
    public static Worker<String> wGetVariable = new Worker<String>() {
        @Override
        public void run(ThreadRunner r, org.dpohvar.varscript.vs.Thread v, Context f, String d) throws Exception {
    ...
    public static Worker<Void> wRunNew = new Worker<Void>() {
        ...
        public void run(ThreadRunner r, Thread v, Context f, Void d) throws Exception {
            org.dpohvar.varscript.vs.Runnable runnable = v.pop(f.getScope());
    ...
    public static Worker<String> wRunField = new Worker<String>() {
        ...
        public void run(ThreadRunner r, Thread v, Context f, String d) throws Exception {
            ...
            org.dpohvar.varscript.vs.Runnable runnable = (org.dpohvar.varscript.vs.Runnable) obj.getField(d);
    ...
    public static Worker<String> wApplyFunction = new Worker<String>() {
        ...
        public void run(ThreadRunner r, Thread v, Context f, String d) throws Exception {
            ...
            org.dpohvar.varscript.vs.Runnable run = v.convert(f.getScope(), fun);
        ...
        VSCompiler.addRule(new SimpleCompileRule(
                ...
                new SimpleWorker(new int[]{0x1F, 0x00}) {
                    ...
                    public void run(ThreadRunner r, Thread v, Context f, Void d) throws ConvertException {
                        ...
                        org.dpohvar.varscript.vs.Runnable runnable;
                        try {
                            runnable = v.peek(org.dpohvar.varscript.vs.Runnable.class);
        ...
        VSCompiler.addRule(new SimpleCompileRule(
                ...
                new SimpleWorker(new int[]{0x1F, 0x01}) {
                    ...
                    public void run(ThreadRunner r, Thread v, Context f, Void d) throws ConvertException {
                        ...
                        org.dpohvar.varscript.vs.Runnable runnable;
                        try {
                            runnable = v.convert(org.dpohvar.varscript.vs.Runnable.class, t);
                        } catch (ConvertException ignored) {
