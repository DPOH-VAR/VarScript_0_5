...
import org.dpohvar.varscript.trigger.*;
    ...
    public static void load() {
        VSCompiler.addRule(new SimpleCompileRule(
                ...
                new SimpleWorker(new int[]{0xF0}) {
                    @Override
                    public void run(ThreadRunner r, final org.dpohvar.varscript.vs.Thread v, Context f, Void d) throws Exception {
        ...
        VSCompiler.addRule(new SimpleCompileRule(
                ...
                new SimpleWorker(new int[]{0xF1}) {
                    ...
                    public void run(ThreadRunner r, final Thread v, final Context f, Void d) throws Exception {
                        ...
                        final org.dpohvar.varscript.vs.Runnable function = v.pop(f.getScope());
